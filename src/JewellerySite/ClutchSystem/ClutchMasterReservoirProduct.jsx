...
import './ClutchCable.css';



const ClutchMasterReservoirProduct = ({ products, addToCart, addToWishlist }) => {
  ...
  return (
    <div>
      <div className="container">
        <center>
          <h1>Clutch Master Reservoir Product</h1>
        </center>
        <div className="btn">
...
export default ClutchMasterReservoirProduct ;
