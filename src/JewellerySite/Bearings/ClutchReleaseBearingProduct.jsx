...
import './AlternatorBearing.css';

const ClutchReleaseBearingProduct = ({ products, addToCart, addToWishlist }) => {
  ...
  return (
    <div>
      <div className="container">
        <center>
          <h1>Clutch Release Bearing Product</h1>
        </center>
        <div className="btn">
...
export default ClutchReleaseBearingProduct ;
