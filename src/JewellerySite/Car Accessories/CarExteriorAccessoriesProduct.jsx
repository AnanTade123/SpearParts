...
import './BackupCamera.css';

const CarExteriorAccessoriesProduct = ({ products, addToCart, addToWishlist }) => {
  ...
  return (
    <div>
      <div className="container">
        <center>
          <h1>Car Exterior Accessories Product</h1>
        </center>
        <div className="btn">
...
export default CarExteriorAccessoriesProduct ;
