...
const CarInteriorAccessoriesProduct = ({ products, addToCart, addToWishlist }) => {
  ...
  return (
    <div>
      <div className="container">
        <center>
          <h1>Car Interior Accessories Product</h1>
        </center>
        <div className="btn">
...
export default CarInteriorAccessoriesProduct ;
